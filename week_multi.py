...
beam1 = np.loadtxt('beam01/week/result_norm')
beam2 = np.loadtxt('beam02/week/result_norm')
beam10 = np.loadtxt('beam10/week/result_norm')
...
ax3.set_xticklabels(['Mon.','Tues.','Wed.','Thur.','Fri.','Sat.','Sun.'])
ax3.set_xlabel('Week',labelpad=5,fontsize=12)
